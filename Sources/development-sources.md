...
1. [Going to Production](https://github.com/mtdvio/going-to-production/tree/master)

## Server Side

1. [12 factor applications](http://12factor.net/)
1. [Production Quality NodeJS Applications](http://caines.ca/blog/2014/06/01/production-quality-node-dot-js-web-apps-part-i/)
1. [OWASP Top 10 Vulnerabilities Report](http://owasptop10.googlecode.com/files/OWASP%20Top%2010%20-%202013.pdf)
1. [AWS Security Best Practices](https://aws.amazon.com/whitepapers/aws-security-best-practices/)
